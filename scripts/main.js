...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const totalCreditSpan = document.getElementById("totalCredits");
    ...
    function calculateTotal(courseList) {
        ...
        if (totalCreditSpan) totalCreditSpan.textContent = totalCredits;
    }
    ...
    const yearSpan = document.querySelector('#currentyear') || document.querySelector('#year');
